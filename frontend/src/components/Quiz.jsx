...
const Quiz = ({ section, roadmapKey, onClose, onComplete, quizData }) => {
      ...
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
        <div className="bg-gray-900 rounded-xl p-8 max-w-2xl w-full border border-gray-800">
          <div className="text-center">
            <p className="text-gray-400 mb-4">Quiz not available for this section yet.</p>
            <button
              onClick={onClose}
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-gray-900 rounded-xl p-8 max-w-2xl w-full border border-gray-800 max-h-[90vh] overflow-y-auto">
        {!showResult ? (
          <>
            <div className="flex justify-between items-start mb-6">
              <div>
                <h2 className="text-2xl font-bold text-white mb-2">{section.title} Quiz</h2>
            ...
            <div className="text-center">
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="flex-1 py-3 bg-cyan-400 hover:bg-cyan-500 text-gray-900 font-bold rounded-lg transition-colors"
                >
                  Continue
                </button>
              </div>
